...
| 5 | Flink-native event-time GPS validation | Spark micro-batch (500ms default) | Sub-second vs. minute-scale latency | Architectural difference | [ESTIMATED only] | **Tier 2 — Estimated** | Latency profiling on Flink vs. Spark on identical NYC MTA Bus stream |
